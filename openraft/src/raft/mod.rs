...
where C: RaftTypeConfig
{
    ...
    ///
    /// The request function will be called with a shared reference to the current state of the
    /// system and serialized with other Raft core loop processing (e.g., client requests or
